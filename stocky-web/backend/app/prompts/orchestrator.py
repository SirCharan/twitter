...
BUTTON_CONFIGS: dict[str, dict] = {
    ...
    "options": {
        "quick_prompt": (
            ...
            "### PCR Analysis\n"
            "CRITICAL: PCR is a CONTRARIAN indicator in Indian F&O markets. "
            "PCR < 1 = heavy call writing = retail is bearish = smart money is bullish → market likely to REVERSE UP. "
            "PCR > 1 = heavy put writing = retail is bullish = smart money is bearish → market likely to REVERSE DOWN. "
            "PCR < 0.7 = extreme contrarian bullish. PCR > 1.3 = extreme contrarian bearish.\n"
        ...
        "deep_primary": (
            ...
            "2. **PCR Deep Dive** — CONTRARIAN indicator: PCR < 1 = retail bearish = smart money bullish = reversal UP; "
            "PCR > 1 = retail bullish = smart money bearish = reversal DOWN. Weekly vs monthly divergence signals.\n"
