      ...
      <nav className="max-w-6xl mx-auto px-4 py-4 md:px-6 md:py-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <a
            ...
            target="_blank"
            rel="noopener"
            className="text-xs px-3 py-1.5 rounded border hover:opacity-80 transition-opacity flex items-center gap-1.5"
          ...
          <button
            ...
            className="text-xs px-3 py-1.5 rounded border hover:opacity-80 transition-opacity flex items-center gap-1.5"
            style={{ color: "#f87171", borderColor: "rgba(248,113,113,0.3)", background: "none" }}
          >
            &#9993; Feedback
          </button>
          <a
            ...
            rel="noopener"
            className="text-xs px-3 py-1.5 rounded border hover:opacity-80 transition-opacity"
            style={{ color: "#F5F0EB", borderColor: "rgba(245,240,235,0.2)" }}
          >
            Terminal
          </a>
          <a
            ...
            target="_blank"
            rel="noopener"
            className="text-xs px-3 py-1.5 rounded border hover:opacity-80 transition-opacity tracking-widest uppercase"
            style={{ color: "#C9A96E", borderColor: "#C9A96E", letterSpacing: "0.15em" }}
          >
            Try Stocky AI
          </a>
        </div>
