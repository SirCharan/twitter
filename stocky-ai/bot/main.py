...
from bot.handlers import alert, analyse, auth, exitrule, help, market, maxloss, news, nlp, overview, portfolio, stoploss, trading, usage
...
def main():
    ...
    app.add_handler(CommandHandler("overview", overview.overview_command))
